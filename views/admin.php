  ...
  <div class="page animsition">
    ...
    <div class="page-content">
      <div class="panel">
        ...
        <div class="row">
            <div class="col-md-12">
              <a href="<?php echo _DOMAIN."index.php?page=usuarios";?>" class="btn btn-dred btn-lg" role="button">
                  <span class="glyphicon glyphicon-user glyphsize"></span>
                  <br/>
                  Administrar<br/>
                  Usuarios
              </a>
              <a href="<?php echo _DOMAIN."index.php?page=asignaroles";?>" class="btn btn-dred btn-lg" role="button">
                  <span class="glyphicon glyphicon-user glyphsize"></span>
                  <br/>
                  
                  Roles de<br/>  Usuarios
              </a>
            </div>
        </div>
